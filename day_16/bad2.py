...
def exploreNeigbors(world: list[list[str]], currentEntry: tuple[int, int, str], currentDistance,
                    queu: list[tuple[int, int, str]], distances: dict[tuple[int, int, str], int],
                    prevs: dict[tuple[int, int, str], list[tuple[int, int, str]]]):
...
# row 7 col 5
def countTiles(prevs: dict[tuple[int, int, str], list[tuple[int, int, str]]], endEntry: tuple[int, int, str],
               startEntry: tuple[int, int, str]):
